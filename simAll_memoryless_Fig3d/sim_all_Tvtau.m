 % Goal: simulate memoryless model for different nutrient pulsing periods
...
per = [0.5 1 2 2.5 6] ;
exp_type = [1 1 1 1 1] ; % type of experiment (upshift, downshift, fluctuating)
start = [0 0 1.15 0 3.8] ;
bound_up = [6.75 6.5 7 6.25 9] ;
